...
if __name__ == '__main__':
    # Directly specify the paths here
    path_model_best = '/model/model_best.pt'
    path_model_tennis_court = '/model/model_tennis_court_det.pt'
    path_model_bounce = '/model/ctb_regr_bounce.cbm'
    path_input_video = '/input_videos/input_video.mp4'
    path_output_video = '/output_videos/output_videos.avi'
    ...
    court_detector = CourtDetectorNet(path_model_tennis_court, device)
